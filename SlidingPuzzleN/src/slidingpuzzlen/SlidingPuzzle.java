...
public class SlidingPuzzle {
	...
	public void initialisation() {
		...
		// initialisation du tableau de nombres à -1 pour ne pas avoir de
	...
	public void initTrie() {
		...
		this.getCoordonnees()[0] = this.getDimension()-1;
		this.getCoordonnees()[1] = this.getDimension()-1;
	...
	public void affichage() {
		...
		System.out.println("coord case vide : " + this.getCoordonnees()[0] + " ; " + this.getCoordonnees()[1]);
